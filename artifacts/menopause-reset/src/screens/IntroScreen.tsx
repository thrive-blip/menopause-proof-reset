      ...
      <div className="max-w-xl w-full text-center space-y-7">
        <div className="space-y-4">
          ...
          <p className="text-base md:text-lg" style={{ color: BRAND.ink, lineHeight: 1.7 }}>
            A short quiz to find your pattern, then a few about your actual workday. In about 20 minutes, you'll see what's really costing you, plus a personalized reset to start tomorrow.
          </p>
